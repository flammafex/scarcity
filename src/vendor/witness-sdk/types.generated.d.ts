 ...
 * fails.
 */
export type WitnessWireTypes = AnchorProviderConfig | AnchorProviderType | Attestation | AttestationBatch | AttestationEvent | AttestationJobResponse | AttestationJobStatus | AttestationSignatures | BatchInclusion | CreateAttestationRequest | CrossAnchor | ExternalAnchorProof | ExternalAnchorsConfig | FederationConfig | FreebirdToken | LogConsistencyProof | LogInclusionProofResponse | MerkleProof | MerkleProofResponse | NetworkConfig | NetworkConfigPublic | PeerNetworkInfo | ProofBundle | ProofBundleVerification | ProofVerificationConfig | SignatureScheme | SignedAttestation | SignedTreeHead | TimestampRequest | TimestampResponse | TreeHead | VerificationLevel | VerifyRequest | VerifyResponse | WitnessInfo | WitnessSignature;
/**
 ...
 */
export type VerificationLevel = "None" | "Basic" | "Batched" | {
    Federated: {
        peer_count: number;
    };
};
